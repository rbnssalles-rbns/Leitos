...
if uploaded_file is not None:
    ...
    # Conferir se FINALIZADO e TEMPO_TOTAL existem
    if "FINALIZADO" not in df.columns or "TEMPO_TOTAL" not in df.columns:
        st.error("As colunas 'FINALIZADO' e/ou 'TEMPO_TOTAL' não foram encontradas no arquivo.")
